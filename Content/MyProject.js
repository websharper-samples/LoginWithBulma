...
{
 "use strict";
 var Global,MyProject,Client,WebSharper,UI,Var,Operators,Unchecked,System,Guid,Obj,List,T,AttrModule,View,Arrays,Templating,Runtime,Server,TemplateInstance,JavaScript,JSModule,Utils,Handler,Runtime$1,ConcreteVar,Snap,Pervasives,Attrs,DomUtility,Strings,Collections,Dictionary,HashSet,Client$1,Seq,Abbrev,Fresh,AttrProxy,DynamicAttrNode,Doc,DictionaryUtil,Enumerator,Object,T$1,Numeric,EventTarget,Node,SC$1,DocElemNode,CharacterData,Slice,Docs,Elt,Mailbox,HashSetUtil,Queue,Client$2,Attrs$1,Dyn,SC$2,CheckedInput,Array,Updates,Docs$1,RunState,NodeSet,An,String,Concurrency,Anims,AppendList,Settings,Char,SC$3,AsyncBody,SC$4,CT,SC$5,HashSet$1,SC$6,Scheduler,CancellationTokenSource,Easing,OperationCanceledException,SC$7,Lazy,DomNodes,LazyExtensionsProxy,LazyRecord,Math,IntelliFactory,Runtime$2,console,$,Date;
 Global=window;
 MyProject=Global.MyProject=Global.MyProject||{};
 Client=MyProject.Client=MyProject.Client||{};
 ...
 SC$2=Global.StartupCode$WebSharper_UI$Doc_Client=Global.StartupCode$WebSharper_UI$Doc_Client||{};
 ...
 SC$7=Global.StartupCode$WebSharper_UI$AppendList=Global.StartupCode$WebSharper_UI$AppendList||{};
 ...
 {
  var passwordValid,emailValid,p,t,p$1,p$2,$1,c,$2,ti,p$3;
  function f(e)
  {
   passwordValid.Set(!Strings.IsNullOrWhiteSpace(e.Vars.Hole("password").Get()));
   emailValid.Set(!Strings.IsNullOrWhiteSpace(e.Vars.Hole("email").Get()));
   passwordValid.Get()&&emailValid.Get()?Global.alert((function($3)
   {
    return function($4)
    {
     return $3("Your email is "+Utils.toSafe($4));
    };
   }(Global.id))(e.Vars.Hole("email").Get())):void 0;
   e.Event.preventDefault();
  }
  passwordValid=Var.Create$1(true);
  emailValid=Var.Create$1(true);
  p=(t=(p$1=(p$2=($1=(c=Guid.NewGuid(),Global.String(c)),($2=new T({
   $:1,
   $0:{
    $:3,
    $0:"attremail",
    $1:AttrModule.DynamicClassPred("is-danger",View.Map(function($3)
    {
     return!$3;
    },emailValid.get_View()))
   },
   ...
   $0:{
    $:3,
    $0:"attremailmessage",
    $1:AttrModule.DynamicClassPred("hidden",emailValid.get_View())
   },
   $1:$2
  })])),[p$2[0],p$2[1],new T({
   $:1,
   ...
   $0:{
    $:3,
    $0:"attrpasswordmessage",
    $1:AttrModule.DynamicClassPred("hidden",passwordValid.get_View())
   },
   $1:p$1[2]
  })]),[t[0],t[1],new T({
   $:1,
  ...
  p$3=Handler.CompleteHoles(p[1],p[2],[["email",0],["password",0],["rememberme",2]]);
  p[0][0]=new TemplateInstance.New(p$3[1],Runtime$1.RunTemplate(p$3[0]));
 };
 ...
 Obj=WebSharper.Obj=Runtime$2.Class({
  Equals:function(obj)
  {
   return this===obj;
  },
 ...
 Var=UI.Var=Runtime$2.Class({},Obj,Var);
 Var.New=Runtime$2.Ctor(function()
 {
 },Var);
 ...
 Handler.CompleteHoles=function(a,filledHoles,vars)
 {
  ...
  try
  {
   while(e.MoveNext())
    {
     h=e.Current();
     (h.$==7?($1=[h.$0,Client$1.Box(h.$1)],true):h.$==10?($1=[h.$0,Client$1.Box(h.$1)],true):h.$==9?($1=[h.$0,Client$1.Box(h.$1)],true):h.$==12?($1=[h.$0,Client$1.Box(h.$1)],true):h.$==11?($1=[h.$0,Client$1.Box(h.$1)],true):h.$==8&&($1=[h.$0,Client$1.Box(h.$1)],true))?(n=$1[0],filledVars.Add(n),allVars.set_Item(n,$1[1])):void 0;
    }
  }
  finally
  {
 ...
 ConcreteVar=UI.ConcreteVar=Runtime$2.Class({
  get_View:function()
  {
   return this.view;
  },
 ...
 ConcreteVar.New=Runtime$2.Ctor(function(isConst,initSnap,initValue)
 {
  var $this;
  $this=this;
  Var.New.call(this);
 ...
 Dictionary=Collections.Dictionary=Runtime$2.Class({
  get_Item:function(k)
  {
   return this.get(k);
  },
 ...
 Dictionary.New$5=Runtime$2.Ctor(function()
 {
  Dictionary.New$6.call(this,[],Unchecked.Equals,Unchecked.Hash);
 },Dictionary);
 Dictionary.New$6=Runtime$2.Ctor(function(init,equals,hash)
 {
  var e,x;
  this.equals=equals;
  this.hash=hash;
 ...
 HashSet=Collections.HashSet=Runtime$2.Class({
  Add:function(item)
  {
 ...
 HashSet.New$3=Runtime$2.Ctor(function()
 {
  HashSet.New$4.call(this,[],Unchecked.Equals,Unchecked.Hash);
 },HashSet);
 HashSet.New$4=Runtime$2.Ctor(function(init,equals,hash)
 {
  var e;
  this.equals=equals;
  this.hash=hash;
 ...
 HashSet.New$2=Runtime$2.Ctor(function(init)
 {
 ...
 AttrProxy=UI.AttrProxy=Runtime$2.Class({},null,AttrProxy);
 ...
 DynamicAttrNode=UI.DynamicAttrNode=Runtime$2.Class({
  NChanged:function()
  {
   return this.updates;
  },
 ...
 DynamicAttrNode.New=Runtime$2.Ctor(function(view,push)
 {
  var $this;
  $this=this;
  this.push=push;
 ...
 Doc=UI.Doc=Runtime$2.Class({},Obj,Doc);
  ...
  function mapHoles(t,mappings)
  {
   ...
   return DomUtility.IterSelector(t,"[ws-attr-holes]",function(e)
   {
    ...
    for(i=0,$1=holeAttrs.length-1;i<=$1;i++)(function()
    {
     ...
     return e.setAttribute(attrName,(((Runtime$2.Curried3(Seq.fold))(f))(e.getAttribute(attrName)))(mappings));
    }());
   });
  }
 ...
 Doc.RunInPlace=function(parent,doc)
 {
  var d;
  d=doc.docNode;
 ...
 Doc.InlineTemplate=function(el,fillWith)
 {
  ...
  function addAttr(el$1,attr)
  {
   ...
   o=Runtime$2.GetOptional(attr$1.OnAfterRender);
  ...
  return[Runtime$2.DeleteEmptyFields({
   Els:els,
   Dirty:true,
   Holes:holes,
   Attrs:attrs,
 ...
 Doc.New=Runtime$2.Ctor(function(docNode,updates)
 {
 ...
 T$1=Enumerator.T=Runtime$2.Class({
  MoveNext:function()
  {
   return this.n(this);
  },
 ...
 T$1.New=Runtime$2.Ctor(function(s,c,n,d)
 {
  this.s=s;
  this.c=c;
  this.n=n;
 ...
 View=UI.View=Runtime$2.Class({},null,View);
 ...
 DocElemNode=UI.DocElemNode=Runtime$2.Class({
  Equals:function(o)
  {
 ...
 DocElemNode.New=function(Attr,Children,Delimiters,El,ElKey,Render)
 {
  ...
  return new DocElemNode(($1={
   ...
   El:El,
   ElKey:ElKey
  },(Runtime$2.SetOptional($1,"Delimiters",Delimiters),Runtime$2.SetOptional($1,"Render",Render),$1)));
 };
 ...
 Docs.CreateElemNode=function(el,attr,children)
 {
  ...
  return DocElemNode.New(attr$1,children,null,el,Fresh.Int(),Runtime$2.GetOptional(attr$1.OnAfterRender));
 };
 ...
 {
  var m;
  m=Runtime$2.GetOptional(el.Render);
  m!=null&&m.$==1?(m.$0(el.El),Runtime$2.SetOptional(el,"Render",null)):void 0;
 };
 Docs.DoSyncElement=function(el)
 {
  ...
  }),DomNodes.Except(DomNodes.DocChildren(el),DomNodes.Children(el.El,Runtime$2.GetOptional(el.Delimiters))));
  ins(el.Children,(m=Runtime$2.GetOptional(el.Delimiters),m!=null&&m.$==1?m.$0[1]:null));
 };
 Elt=UI.Elt=Runtime$2.Class({},Doc,Elt);
 ...
 Elt.New$1=Runtime$2.Ctor(function(docNode,updates,elt,rvUpdates)
 {
 ...
 Dyn.New=function(DynElem,DynFlags,DynNodes,OnAfterRender)
 {
  ...
  Runtime$2.SetOptional($1,"OnAfterRender",OnAfterRender);
  return $1;
 };
 SC$2.$cctor=function()
 {
  SC$2.$cctor=Global.ignore;
  SC$2.BatchUpdatesEnabled=true;
  SC$2.LoadedTemplates=new Dictionary.New$5();
  SC$2.LocalTemplatesLoaded=false;
  SC$2.TextHoleRE="\\${([^}]+)}";
 };
 CheckedInput=UI.CheckedInput=Runtime$2.Class({
  get_Input:function()
  {
 ...
 Updates=UI.Updates=Runtime$2.Class({},null,Updates);
 ...
 {
  SC$2.$cctor();
  return SC$2.BatchUpdatesEnabled;
 };
 ...
 SC$6.$cctor=function()
 {
  ...
  SC$6.Doc=Global.document;
 };
 Scheduler=Concurrency.Scheduler=Runtime$2.Class({
 ...
 Scheduler.New=Runtime$2.Ctor(function()
 {
  this.idle=true;
  this.robin=[];
 },Scheduler);
 CancellationTokenSource=WebSharper.CancellationTokenSource=Runtime$2.Class({},Obj,CancellationTokenSource);
 CancellationTokenSource.New=Runtime$2.Ctor(function()
 {
  this.c=false;
  this.pending=null;
  this.r=[];
 ...
 Easing=UI.Easing=Runtime$2.Class({},Obj,Easing);
 Easing.Custom=function(f)
 {
  return new Easing.New(f);
 };
 Easing.New=Runtime$2.Ctor(function(transformTime)
 {
  this.transformTime=transformTime;
 },Easing);
 OperationCanceledException=WebSharper.OperationCanceledException=Runtime$2.Class({},null,OperationCanceledException);
 OperationCanceledException.New=Runtime$2.Ctor(function(ct)
 {
  OperationCanceledException.New$1.call(this,"The operation was canceled.",null,ct);
 },OperationCanceledException);
 OperationCanceledException.New$1=Runtime$2.Ctor(function(message,inner,ct)
 {
